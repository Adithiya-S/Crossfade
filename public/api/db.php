...
$host = '127.0.0.1'; // Hostinger usually uses localhost
$db   = 'crossfade_db'; // Replace with actual DB name
$user = 'root'; // Replace with Hostinger DB user
$pass = ''; // Replace with Hostinger DB password
$charset = 'utf8mb4';
