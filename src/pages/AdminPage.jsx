                                ...
                                {editingType === 'workshop' && (
                                    <>
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="col-span-2"><label className="block text-sm mb-1 text-green-mid">Title</label><input type="text" required placeholder="e.g. Workshop 1" value={currentData.title || ''} onChange={e => setCurrentData({ ...currentData, title: e.target.value })} className="w-full px-4 py-2 rounded-xl border bg-gray-50 outline-none focus:border-pink-hot" /></div>
                                            <div><label className="block text-sm mb-1">Category</label><input type="text" placeholder="e.g. Beginner" value={currentData.category || ''} onChange={e => setCurrentData({ ...currentData, category: e.target.value })} className="w-full px-4 py-2 rounded-xl border bg-gray-50 outline-none focus:border-pink-hot" /></div>
                                            <div><label className="block text-sm mb-1">Price</label><input type="text" placeholder="e.g. 3000" value={currentData.price || ''} onChange={e => setCurrentData({ ...currentData, price: e.target.value })} className="w-full px-4 py-2 rounded-xl border bg-gray-50 outline-none focus:border-pink-hot" /></div>
                                            ...
                                            <div><label className="block text-sm mb-1">Spots / Group Size</label><input type="text" placeholder="e.g. Max 4 people" value={currentData.spots || currentData.group_size || ''} onChange={e => setCurrentData({ ...currentData, spots: e.target.value, group_size: e.target.value })} className="w-full px-4 py-2 rounded-xl border bg-gray-50 outline-none focus:border-pink-hot" /></div>
